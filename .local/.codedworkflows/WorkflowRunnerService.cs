...
using DbConnectionsPOCs;

[assembly: WorkflowRunnerServiceAttribute(typeof(DbConnectionsPOCs.WorkflowRunnerService))]
namespace DbConnectionsPOCs
{
    public class WorkflowRunnerService
    {
        ...
        /// <summary>
        /// Invokes the API.xaml
        /// </summary>
        public void API()
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"API.xaml", new Dictionary<string, object> { }, default, default, default, GetAssemblyName());
        }
        ...
        public void API(System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"API.xaml", new Dictionary<string, object> { }, default, isolated, default, GetAssemblyName());
        }
        ...
        /// </summary>
        public void Test(string in_OrchestratorQueueFolder, string in_OrchestratorQueueName)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Test.xaml", new Dictionary<string, object> { { "in_OrchestratorQueueFolder", in_OrchestratorQueueFolder }, { "in_OrchestratorQueueName", in_OrchestratorQueueName } }, default, default, default, GetAssemblyName());
        }
        ...
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public void Test(string in_OrchestratorQueueFolder, string in_OrchestratorQueueName, System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Test.xaml", new Dictionary<string, object> { { "in_OrchestratorQueueFolder", in_OrchestratorQueueFolder }, { "in_OrchestratorQueueName", in_OrchestratorQueueName } }, default, isolated, default, GetAssemblyName());
        }
        ...
        public void HIL()
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"HIL.cs", new Dictionary<string, object> { }, default, default, default, GetAssemblyName());
        }
        ...
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public void HIL(System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"HIL.cs", new Dictionary<string, object> { }, default, isolated, default, GetAssemblyName());
        }
